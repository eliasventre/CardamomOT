...
# ./run.sh experimental_datasets/Semrau  full  0.7 0 1 1 1 1 1 0 0 1 0 0 --species mouse
# ./run.sh experimental_datasets/Kameneva  full  0.7 0 0.5 0.2 1 1 1 0 0 1 0 0 --species human
