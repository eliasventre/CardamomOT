...
# ./run.sh experimental_datasets/Semrau train 0 0.7 1.0
./run.sh experimental_datasets/Kameneva train 0 0.7 0.5
# ./run.sh experimental_datasets/Schiebinger/ train 0 0.3 0.0
