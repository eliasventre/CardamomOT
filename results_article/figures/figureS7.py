...
def main():
    ...
    plt.savefig('figureS7.png', dpi=300, bbox_inches='tight', pad_inches=0.05)
    print("\nSaved figureS7.png")

    try:
        from PIL import Image
        Image.open('figureS7.png').convert('RGB').save(
            'figureS7.pdf', 'PDF', resolution=300)
        print("Saved figureS7.pdf")
    except ImportError:
