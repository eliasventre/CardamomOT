...
for r in range(0, N):
    ...
    score = model.inter
    np.save('FN4/CARDAMOM2_degover2/score_{}'.format(r+1), score)
...
for r in range(0, N):
    ...
    model.fit(x, verb=verb)
    score = model.inter
    np.save('CN5/CARDAMOM2_degover2/score_{}'.format(r+1), score)
...
for r in range(0, N):
    ...
    model.fit(x, verb=verb)
    score = model.inter
    np.save('BN8/CARDAMOM2_degover2/score_{}'.format(r+1), score)
...
for r in range(0, N):
    ...
    model.fit(x, verb=verb)
    score = model.inter
    np.save('FN8/CARDAMOM2_degover2/score_{}'.format(r+1), score)
